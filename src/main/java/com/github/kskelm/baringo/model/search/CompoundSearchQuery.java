...
public class CompoundSearchQuery {
    ...
    private final QueryElement user;
    private final QueryElement title;
    private final QueryElement extension;
    private final QueryElement subReddit;
    private final QueryElement album;
    private final QueryElement meme;
    ...
    public String toString() {
        String buf = String.valueOf(user) +
                title +
                extension +
                subReddit +
                album +
    ...
    public class QueryElement {
        ...
        private final CompoundSearchQuery parent;
